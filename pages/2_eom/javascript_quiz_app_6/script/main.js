...
let mainQuestions = [
    {
        text: 'Алгоритм Эль-Гамаля основан на трудности:',
        right: [2],
        type: 1,
        points: 100,
        answers: ['возведения целых чисел в степень по модулю', 'разложения больших чисел на множители', 'вычисления дискретных логарифмов', 'решения задачи факторизации',],
    },
];
