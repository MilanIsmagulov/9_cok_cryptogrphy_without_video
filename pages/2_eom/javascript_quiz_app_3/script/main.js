...
let mainQuestions = [
    {
        ...
        type: 1,
        points: 100,
        answers: ['на трудности возведения целых чисел в степень по модулю', 'на трудности решения задачи факторизации', 'на трудности деления больших целых чисел', 'на трудности вычисления дискретных логарифмов',],
    },
];
