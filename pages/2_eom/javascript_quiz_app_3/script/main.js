...
let mainQuestions = [
    {
        text: 'Укажите, на чем основана безопасность алгоритма RSA для формирования цифровой подписи:',
        right: [1],
        type: 1,
        points: 100,
        answers: ['на трудности возведения целых чисел в степень по модулю', 'на трудности решения задачи факторизации', 'на трудности возведения целых чисел в степень по модулю', 'на трудности вычисления дискретных логарифмов',],
    },
];
