...
let mainQuestions = [
    {
        text: 'Укажите, что обеспечивает цифровая подпись:',
        right: [3],
        type: 1,
        points: 100,
        answers: ['установление лица, отправившего документ', 'проверку целостности документов', 'конфиденциальность документов', 'все выше перечисленные варианты ответов',],
    },
];
