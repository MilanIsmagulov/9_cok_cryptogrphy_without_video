...
let mainQuestions = [
    {
        text: 'Выберите, какие из утверждений об алгоритме RSA являются верными:',
        right: [0,2,3],
        type: 3,
        points: 100,
        answers: ['был разработан в 1977 году', 'основан на комбинаторных методах', 'используется для шифрования данных', 'является одним из самых популярных алгоритмов шифрования',],
    },
];
