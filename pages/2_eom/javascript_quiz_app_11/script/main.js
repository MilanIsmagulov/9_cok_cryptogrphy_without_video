...
let mainQuestions = [
    {
        text: 'Выберите, каков размер входного блока обрабатываемой информации при использовании стандарта шифрования АES:',
        right: [6],
        type: 1,
        points: 100,
        answers: ['48 бит', '48 байт', '64 бита', '64 байта', '56 бит', '56 байт', '128 бит', '128 байт'],
    },
];
