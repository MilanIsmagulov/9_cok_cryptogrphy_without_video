...
let mainQuestions = [
    {
        text: 'Укажите, как расшифровывается аббревиатура AES:',
        right: [3],
        type: 1,
        points: 100,
        answers: ['Advanced Extended Standard', 'American Extended Standard', 'Analytic Encryption Standard', 'Advanced Encryption Standard',],
    },
];
