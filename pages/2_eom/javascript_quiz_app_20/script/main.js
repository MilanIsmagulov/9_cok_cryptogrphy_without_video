...
let mainQuestions = [
    {
        text: 'Выберите, как называется «исторический» шифр, в котором каждая буква исходного текста заменялась буквой, стоящей на некоторое фиксированное число мест дальше в алфавите:',
        right: [1],
        type: 1,
        points: 100,
        answers: ['шифр Маркова', 'шифр Цезаря', 'шифр Энигма', 'шифр Бэбиджа'],
    },
];
