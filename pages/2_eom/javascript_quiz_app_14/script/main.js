...
let mainQuestions = [
    {
        text: 'Выберите, какие действия можно выполнять с документом, подписанным цифровой подписью:',
        right: [1],
        type: 1,
        points: 100,
        answers: ['только редактирование', 'только чтение', 'чтение и редактирование',],
    },
];
